...
import { useGetBlogPostByCategoryMutation } from "../../../services/blog";
...
const BlogCategory: React.FC = (): ReactElement => {
    ...
    const { categoryUrl }: any = useParams();
    ...
    const [getBlogPostList, getBlogPostStatus] = useGetBlogPostByCategoryMutation();
    ...
    useEffect(() => {
        getBlogPostList({ payload: {url: categoryUrl, keywords: keyWords}, metaData: metaData });
    }, [metaData]);
