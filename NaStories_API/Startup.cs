...
using NaStories.API.Persistence.Repositories;
...
namespace NaStories_API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCors();
            services.AddDbContext<NaStoriesContext>(option =>
            {
                option.UseSqlServer(Configuration.GetConnectionString("NaStories"));
